...
var appConfigFullName= 'laja${appConfigName}${environment}'
...
var svcBusName= '${environment}lajasvcbicepbus'
var svcBusTopicName = '${environment}lajasvcbicepTopic'
var appservicePlanName ='${environment}lajabciepplan'
var appserviceName ='${environment}lajabciepapp'
